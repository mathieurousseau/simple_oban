defmodule SimpleOban.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind simple_oban", "esbuild simple_oban"],
      "assets.deploy": [
        "tailwind simple_oban --minify",
        "esbuild simple_oban --minify",
        "phx.digest"
      ]
    ]
  end
